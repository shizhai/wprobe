cmd_scripts/kconfig/zconf.tab.o := gcc -Wp,-MD,scripts/kconfig/.zconf.tab.o.d -O2 -I/home/shizhai/new_zhongwang/trunk/staging_dir/host/include -Wall -Wmissing-prototypes -Wstrict-prototypes    -DCURSES_LOC="<ncurses.h>" -DLOCALE  -Iscripts/kconfig -c -o scripts/kconfig/zconf.tab.o scripts/kconfig/zconf.tab.c
