...
const struct cl_option cl_options[] =
{
  ...
  { "-cpp",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 3, 1027,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-cpp=",
    0,
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 4, 1027,
  ...
  { "-fsched-spec-load-dangerous",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 769,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-stalled-insns",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 770,
    CL_COMMON | CL_UINTEGER | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched-stalled-insns-dep",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 771,
    CL_COMMON | CL_UINTEGER | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsched2-use-traces",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 18, 776,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fschedule-insns",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 777,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fschedule-insns2",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 778,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsecond-underscore",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 779,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fsection-anchors",
  ...
  { "-fsee",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 4, 781,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fsel-sched-pipelining",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 782,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsel-sched-pipelining-outer-loops",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 33, 783,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsel-sched-reschedule-pipelined",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 31, 784,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fselective-scheduling",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 785,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fshort-double",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 787,
  ...
  { "-fsign-zero",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 791,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fsignaling-nans",
  ...
  { "-fsplit-ivs-in-unroller",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 799,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fsquangle",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 9, 802,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fstack-check",
    ...
    0,
    0,
    "specific", "no", OPT_fstack_check_, N_OPTS, 12, 803,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fstack-check=",
  ...
  { "-fstack-limit",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 805,
    CL_COMMON,
    offsetof (struct gcc_options, x_common_deferred_options), 0, CLVC_DEFER, 0 },
  ...
  { "-fstrict-enums",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 815,
    CL_CXX | CL_ObjCXX | CL_OPTIMIZATION,
  ...
  { "-fstrict-prototype",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 17, 817,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fstrict-volatile-bitfields",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 818,
    CL_COMMON | CL_REPORT,
  ...
  { "-ftarget-help",
    ...
    0,
    0,
    NULL, NULL, OPT__target_help, N_OPTS, 12, 821,
    CL_COMMON | CL_DRIVER,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftarget=",
  ...
  { "-ftest-coverage",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 825,
    CL_COMMON | CL_REPORT,
  ...
  { "-fthis-is-variable",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 17, 826,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fthread-jumps",
  ...
  { "-ftrapping-math",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 833,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-cselim",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 841,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-dominator-opts",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 843,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-distribution",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 848,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-if-convert",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 21, 849,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-if-convert-stores",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 28, 850,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-ivcanon",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 852,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-loop-linear",
    ...
    0,
    0,
    NULL, NULL, OPT_floop_interchange, N_OPTS, 17, 853,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftree-loop-optimize",
  ...
  { "-ftree-salias",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 12, 861,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftree-scev-cprop",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 862,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-sink",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 863,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-store-copy-prop",
    ...
    0,
    0,
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 21, 867,
    CL_COMMON,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-ftree-switch-conversion",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 868,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-ftree-vect-loop-version",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 870,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funit-at-a-time",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 15, 875,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funroll-all-loops",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 876,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-funsigned-bitfields",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 19, 880,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX,
  ...
  { "-funsigned-char",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 881,
    CL_C | CL_CXX | CL_LTO | CL_ObjC | CL_ObjCXX,
  ...
  { "-funwind-tables",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 883,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fuse-atomic-builtins",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 884,
    CL_Java,
  ...
  { "-fuse-divide-subroutine",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 22, 888,
    CL_Java,
  ...
  { "-fuse-linker-plugin",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 889,
  ...
  { "-fvar-tracking-assignments",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 25, 891,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fvar-tracking-assignments-toggle",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 32, 892,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fvar-tracking-uninit",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 20, 893,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fvariable-expansion-in-unroller",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 31, 894,
    CL_COMMON | CL_OPTIMIZATION | CL_REPORT,
  ...
  { "-fversion",
    ...
    0,
    0,
    NULL, NULL, OPT__version, N_OPTS, 8, 897,
    CL_COMMON | CL_DRIVER,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fvisibility-inlines-hidden",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 26, 898,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  ...
  { "-fvtable-gc",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 10, 902,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fvtable-thunks",
    "No longer supported",
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 14, 903,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fweak",
  ...
  { "-fwhole-file",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 906,
    CL_Fortran,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fwhole-program",
  ...
  { "-fworking-directory",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 909,
    CL_C | CL_CXX | CL_Fortran | CL_ObjC | CL_ObjCXX,
  ...
  { "-fxref",
    ...
    0,
    "switch %qs is no longer supported",
    NULL, NULL, OPT_SPECIAL_ignore, N_OPTS, 5, 912,
    CL_CXX | CL_ObjCXX,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-fzee",
  ...
  { "-fzero-initialized-in-bss",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 24, 914,
    CL_COMMON | CL_REPORT,
  ...
  { "-gstabs+",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_gstabs, 7, 929,
    CL_COMMON | CL_JOINED | CL_MISSING_OK,
    -1, 0, CLVC_STRING, 0 },
  { "-gstrict-dwarf",
  ...
  { "-gxcoff+",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, OPT_gxcoff, 7, 918,
    CL_COMMON | CL_JOINED | CL_MISSING_OK,
    -1, 0, CLVC_STRING, 0 },
  { "-h",
    0,
  ...
  { "-mbranch-likely",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 954,
    CL_TARGET | CL_REPORT,
  ...
  { "-mfix-r10000",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 970,
    CL_TARGET | CL_REPORT,
  ...
  { "-mfix-r4400",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 10, 972,
    CL_TARGET | CL_REPORT,
  ...
  { "-mfix-vr4130",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 11, 975,
    CL_TARGET | CL_REPORT,
  ...
  { "-mflip-mips16",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 12, 977,
    CL_TARGET | CL_REPORT,
  ...
  { "-minterlink-mips16",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 17, 988,
    CL_TARGET | CL_REPORT,
  ...
  { "-mmcount-ra-address",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 18, 997,
    CL_TARGET | CL_REPORT,
  ...
  { "-mmt",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 3, 1000,
    CL_TARGET | CL_REPORT,
  ...
  { "-mpaired-single",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 14, 1007,
    CL_TARGET | CL_REPORT,
  ...
  { "-mrelax-pic-calls",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 1010,
    CL_TARGET | CL_REPORT,
  ...
  { "-mshared",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 7, 1011,
    CL_TARGET | CL_REPORT,
  ...
  { "-msplit-addresses",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 16, 1015,
    CL_TARGET | CL_REPORT,
  ...
  { "-muninit-const-in-rodata",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 23, 1020,
    CL_TARGET | CL_REPORT,
  ...
  { "-mvr4130-align",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 13, 1021,
    CL_TARGET | CL_REPORT,
  ...
  { "-mxgot",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 5, 1022,
    CL_TARGET | CL_REPORT,
  ...
  { "-pie",
    ...
    0,
    0,
    NULL, NULL, N_OPTS, N_OPTS, 3, 1062,
    CL_COMMON | CL_REJECT_NEGATIVE,
    -1, 0, CLVC_BOOLEAN, 0 },
  { "-pipe",
    0,
